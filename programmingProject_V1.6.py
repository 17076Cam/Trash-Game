...
Changelog
v1.6
Add list that tells trash you found at end
"""
...
def foundMetal_Tin():
    ...
    while question5 == 1:
        ...
        if userInput.lower() == "1":
            ...
            print("Correct")
            score = score + 1
            trash_collected.append("Metal Tin")
            print("Number of pieces of trash is: %d"%score)
        else:
            question5 = 1 + 1
...
def endText():
    ...
    if score >= 3: #Checks if you picked up over 3 things of trash
        print("Congrats you won") #Text that plays when you  win
        print("You found")
        print(trash_collected)
    else:
        print("Sorry restart the game and try again")
...
while True:
    print("What would you like to do? (m)ove,")#Askes if you want to move
    userInput = input(">>>")
    if userInput.lower() == "m": #Checks if input is m to let you move
        move()
