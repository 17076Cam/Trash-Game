...
Changelog
v1.7
Make it easier to ,ove around and also have the game properly end. And add more comments
"""
...
def foundPlastic_Bag():
    ...
    while question1 == 1:
        ...
        if userInput.lower() == "1000": #The answer
            ...
            question1 = 1 + 1
            print("Wrong Plastic bags can live up to 1000 years\nTry find some more trash you only need 3 pieces to complete your mission") #Tells player the answer
